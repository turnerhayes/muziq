...
const muziq = {
  ...
  dllPlugin: {
    defaults: {
      ...
      path: resolve("../node_modules/muziq-dlls"),
    },

    entry(dependencyNames, pluginConfig) {
      const exclude = pluginConfig.exclude || muziq.dllPlugin.defaults.exclude;
      const include = pluginConfig.include || muziq.dllPlugin.defaults.include;
